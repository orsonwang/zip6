              ...
              <div class="alert alert-success mt-2">
                ...
                <div class="flex-1">
                  ...
                  {addressResult.englishAddress && (
                    <div class="text-sm mt-1 font-mono bg-success/20 px-2 py-1 rounded flex items-center gap-2">
                      <span class="flex-1">{addressResult.englishAddress}</span>
                      <button
                        class="btn btn-ghost btn-xs"
                        onClick={() => copyToClipboard(addressResult.englishAddress)}
                        title="複製英文地址"
                      >
                        {copied ? (
